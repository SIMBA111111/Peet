    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_name', models.CharField(max_length=60, verbose_name='Фамилия')),
                ('last_name', models.CharField(blank=True, max_length=60, verbose_name='Отчество')),
            ...
            options={
                ...
                'db_table': 'UserModel',
                'indexes': [models.Index(fields=['first_name', 'middle_name', 'last_name'], name='fio_idx')],
            },
            managers=[
